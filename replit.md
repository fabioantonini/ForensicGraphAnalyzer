...
- **OTTIMIZZAZIONE PARAMETRI OPENAI QUIZ (Agosto 2025)**: Bilanciati parametri GPT-4o per Wake Up Quiz: temperature ridotta da 1.2 a 0.9, top_p a 0.9, frequency/presence penalty ridotte. Prompt rafforzato con enfasi su accuratezza delle risposte. Risolto problema risposte errate (es. "1984" di Orwell). Sistema ora garantisce varietà delle domande mantenendo correttezza factual assoluta.
